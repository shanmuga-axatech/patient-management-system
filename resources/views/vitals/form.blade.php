@extends('layout.template') @section('list','vitals')
@section('add','vitals/create') @section('content')
@if(count($errors)>0)
...
<hr />
<form method="post" action="/vitals/@yield('patient_id')"
	name="patient_register" id="patient_register">
	...
	<div class="form-group col-md-6">
		...
		<input type="text" class="form-control" name="spo2" id="spo2"
			placeholder="The amount of oxygen in the blood">
	</div>
	<div class="form-group col-md-6">
		<label for="fbs">Fasting Blood Sugar(FBS)</label> <input type="text"
			class="form-control" name="fbs" id="fbs"
			placeholder="Failed back syndrome fasting blood sugar">
	</div>
	<div class="form-group col-md-6">
		<label for="grbs">General Random Blood Sugar(GRBS)</label> <input
			type="text" class="form-control" name="grbs" id="grbs"
			placeholder="General Random Blood Sugar">
	</div>
	<div class="form-group col-md-12">
		<label for="heartbeat">Heart Beat</label> <input type="text"
			class="form-control" name="heartbeat" id="heartbeat"
